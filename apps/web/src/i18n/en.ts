...
export const en = {
  ...
  booking: {
    ...
    actions: 'Actions',
    contactPrivate:
      "Customer contact details stay with Karu. Use the chat below — messages go straight to the customer, with Karu in the room.",
    ...
    airportMeet: 'Airport meet',
    deliveryLabel: 'Delivery',
    time: 'Time',
    driverLabel: 'Driver',
    withDriver: 'With a driver',
    selfDrive: 'Self-drive',
    depositPercent: 'Deposit (15%)',
    city: 'City',
    category: 'Category',
    seats: 'Seats',
    action: {
    ...
    recordDeposit: {
      ...
      sub: 'Use this once the team has actually received or returned money. Nothing is marked paid automatically.',
      status: 'Status',
      statusHeld: 'Deposit received',
      statusReleased: 'Paid out to provider',
      statusRefunded: 'Refunded to customer',
      statusFailed: 'Payment failed',
      reference: 'Reference (optional)',
      referencePlaceholder: 'Bank/transfer ref',
      submit: 'Record',
      recorded: 'Recorded ✓',
    },
  },
  chat: {
    title: 'Messages',
    introAdmin: 'You are posting as Karu Support — both parties see your messages.',
    intro:
    ...
    you: 'You',
    redactedMessage: 'Contact details were removed from this message.',
    placeholder: 'Write a message…',
    send: 'Send',
    redactedNotice:
      'Your message was delivered, but contact details were removed — Karu keeps all communication on the platform.',
    assistanceOpen: 'Karu has been asked to look at this booking. Someone will join the conversation.',
    stuckPrompt: 'Stuck, or something has gone wrong?',
    askForHelp: 'Ask Karu for help',
  },
  review: {
